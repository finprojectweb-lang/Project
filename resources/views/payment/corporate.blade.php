...
@section('title', 'Corporate Payment - NulliCarbon')
...
<div class="payment-container">
    <div class="payment-wrapper">
        ...
        <div class="payment-header">
            ...
            <p class="page-subtitle">Offset your company's carbon footprint and contribute to environmental projects</p>
        </div>
        ...
        <div class="payment-content">
                ...
                <div class="summary-card">
                    ...
                    <div class="calculation-details">
                        <div class="detail-row">
                            ...
                            <span class="detail-value">{{ $calculation->company_name }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">Total Carbon Emission</span>
                            <span class="detail-value">{{ number_format($carbonAmount, 2) }} Ton CO₂e</span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">Calculation Year</span>
                            <span class="detail-value">{{ $calculation->calculation_year }}</span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">Offset Rate</span>
                            <span class="detail-value">Rp {{ number_format($rate, 0, ',', '.') }}/kg</span>
                        </div>
                    </div>
                    ...
                    <div class="total-section">
                        ...
                        <div class="total-row">
                            ...
                            <span class="total-value">Rp {{ number_format($adminFee, 0, ',', '.') }}</span>
                        </div>
            ...
            <div class="form-section">
                <form action="{{ route('payment.process') }}" method="POST" class="payment-form" id="paymentForm">
                    @csrf
                    <input type="hidden" name="carbon_amount" value="{{ $calculation->total_emission }}">
                    ...
                    <div class="form-group-wrapper">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control" required value="{{ old('name', Auth::user()->name) }}">
                        </div>

                        <div class="form-group">
                            <label for="email" class="form-label">Email Address *</label>
                            <input type="email" id="email" name="email" class="form-control" required value="{{ old('email', Auth::user()->email) }}">
                        </div>
...
<script>
// Sesuaikan carbonAmount dengan: 
const carbonAmount = parseFloat('{{ $calculation->total_emission }}') || 0;
</script>
